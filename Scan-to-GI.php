...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Scan and Post Goods Issue</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Scan to GI(Goods Issue)</div>
				...
				<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								...
								============================================= -->
									...
									<a href="https://www.youtube.com/watch?v=ny5UtalxPEk?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
									<img src="demos/business/images/sections/scan-to-GI.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 50%; left: 50%; font-size: 60px; color: #ccc; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Scan and Post Goods Issue</h3>
								</div>
								<p class="font-weight-normal">One more challenge in enterprises is Goods issue as it is manual.  Warehouse/Storage location issues more units of goods either to customers, production, sub-contracting, or in any other way almost  a couple of days in a week. It is very time consuming to the clerk to note down every item with quantity and post it in ERP. </p>
								
								<p class="font-weight-normal">This app provides great mobility to your warehouse clerks by accessing Mobile app using tablets or smartphones by scanning QR Code and posting a Goods Issue for both outbound and inbound Delivery.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Goods Issue (GI)</b></h3>
									<p class=" text-dark">You can open the app with login pin or Biometric (Thumb). Just scan the QR code which consists of, Material, Quantity and Unit of measure. App reads data from it and add line item as and when you scan a QR Code of item. Just click Post GI button to post Goods Issue once scanning is over. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>No Additional Cost</b> </h3>
									<p class="text-dark">Normally QR Code reader/ RF Gun costs good amount of money and need more devices depending on the size of warehouse or volume or moving goods and these are exepensive too. Your organization doesn’t need to purchase specific QR code reader device as a simple mobile app will suffice the requirement. It is a cost saving app too. 
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Quicker and Faster</b></h3>
									<p class=" text-dark">Noting down entry of goods manually at warehouse/storage location takes huge amount of time. It makes trucks waiting for longer hours outside the gate. Scanning QR Code and posting GI helps save time and leverage resources effectively and improves supply chain and moving goods too.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Apps Easy to use</b></h3>
									<p class=" text-dark">SAVIC App Center provides partner apps and services that extend the value of Partner Managment App. Mobile Apps are very easy to use can be accessed from any Android/ios smartphone, Tablet and Web. Mobile Apps may need very low or no training hence most of individuals and organizations started using them heavily in this digital age
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">No need to purchase any specific Device other than smartphone,
Clerks smartphone is enough to push the App,
App can be deployed to multiple devices(phones/tablet),
Can go for On & Off mode,
Uses SAP REST API functionality to do this activity.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">Quickly can be deployed at maximum of  3-4 weeks,
Flexible and competitive pricing based on the option,
No additional Hardware, Infrastructure, resources required,
Real-time GR posting, 
System must be enabled to use HTTP and HTTPS protocals.</p>
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>2,25,000
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i>Goods Issue Only</li>
											<li><i class="icon-check text-smaller"></i>Install in one or more <strong>Smartphone/Tablet</strong></li>
											
												<li><i class="icon-check text-smaller"></i><strong>1</strong> Months Support </li>
											<li><i class="icon-check text-smaller" style="margin-bottom:160px;"></i><strong>24/7</strong> Support</li>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<h3>Professional</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>4,25,000
									</div>
								<h3 class="mb-0">Monthly</h3> 
									...
									<div class="pricing-features">
										...
										<li><i class="icon-check text-smaller"></i>Goods Receipt & Goods Issue</li>
											<li><i class="icon-check text-smaller"></i>Install in one or more <strong>Smartphone/Tablet</strong></li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>6,00,000  
									</div>
									<h3 class="mb-0">Monthly</h3> 
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i>Goods Receipt,Goods Issue & Generate QR Code</li>
											<li><i class="icon-check text-smaller"></i>Install in one or more <strong>Smartphone/Tablet</strong></li>
											
											<li><i class="icon-check text-smaller"></i><strong>1</strong> Months Support </li>
											<li><i class="icon-check text-smaller" style="margin-bottom:135px;"></i><strong>24/7</strong> Support</li>
...
<option value="['Zimbabwe','ZW']">Zimbabwe</option>
						...
						<div class="col-12 mt-4">
						<p> <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"> I agree that SAP will share this data with Advantco International LLC so that they may contact me regarding my request.<a href="Privacy.php"> View our Privacy Statement.</a></p>
