...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Cashflow for MSME Vendors</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Cashflow for MSME Vendors</div>
			...
			<div class="content-wrap">
				...
				<div class="row topmargin-md clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
									<a href="https://www.youtube.com/watch?v=xrR2rBR4OP0?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/cashflow-msme.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 45%; left: 50%; font-size: 60px; color:#002D62; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 60px">Cashflow for MSME Vendors</h3>
								</div>
								<p class="font-weight-normal">As per MSME rule, in case the buyer fails to make payment as required under Section 15 of the Micro Small and Medium Enterprises Development Act, the buyer is liable to pay compound interest with monthly rests to the supplier for delayed period beyond 45 days, on the amount, payable at three times the bank rate notified by Reserve Bank. </p>
								<p class="font-weight-normal">
This App helps buyer to maintain cheque details centrally and get alert Buyer on period intervels as and when timeline is approaching </p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Data Replication</b></h3>
									<p class=" text-dark">Master data and relevant cheque data can be maintained in this App either using directly connecting to your ERP system using REST API technique. It also has the feature of uploading Excel or JSON file format do the needful. So, maintaining cheque related transaction data is very easy to create/view/modify. </p>
								</div>
							</div>
						</div>
...
Flexible to access from smartphone or tablet or web,
User must have access to SAP system and a label printer must be connected.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Alert/Notifications</b></h3>
									<p class=" text-dark">The app has the feature to configure alerts mechanism like on how many days in advance user to be notified and how many times user to be notified. A maximum of five times like 10 days in advance, 8 days in advance, 5 days in advance, etc as per business need. Also, analytical reporting is available to see how many cheques are ready to realize in next few days so that you manage cashflow accordingly
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-price text-center text-md-center">
										<span class="price-unit">&#x20B9;</span>649
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist" >
											<li><i class="icon-check text-smaller "></i> <strong>5 </strong> Users</li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go</li>
											<li><i class="icon-check text-smaller"></i> <strong>50 MB </strong>space allocated</li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price text-center text-md-center">
										<span class="price-unit mb-0">&#x20B9;</span>449 
									</div>
									<h3 class="mb-0 text-center text-md-center">Per User/Month</h3> 
