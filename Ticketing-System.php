...
<style>
#page-menu-wrap{background-color:#525252;}
...
<body class="stretched sticky-responsive-pagemenu">
	...
	<?php include('css/header/header.php')?>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Ticketing System  </div>

						<nav class="page-menu-nav one-page-menu">
							<ul class="page-menu-container">
								
								<li class="page-menu-item"><a href="#" data-href="#section-about"><div>At a Glance</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-work"><div>Features</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-pricing"><div>Pricing</div></a></li>
								<li class="page-menu-item"><a href="#" data-href="#section-services"><div>Technical Information</div></a></li>
								
								<li class="page-menu-item"><a href="#" data-href="#section-team"><div>Resource</div></a></li>
								
								<li class="page-menu-item"><a href="#" data-href="#section-testimonials" class="no-offset"><div>Publisher</div></a></li>
							<a href="#modal-get-it-now" data-lightbox="inline" class="button button-small text-black  text-black font-weight-medium py-2 rounded-sm ml-0 ls0 nott"><i class="icon-line-paper"></i><b>Get it now</b></a>
							</ul>
						</nav>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=pGyj3yRv1rg" data-lightbox="iframe">
									<img src="demos/business/images/sections/Ticketing-system.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 40%; left: 50%; font-size: 60px; color: #FFF; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Ticketing, Locker, Merchandise & Access Management System</h3>
								</div>
								<p class="font-weight-normal">Ticketing system is being used for Amuzement Parks, Museums and Tourisam places. Electronic tickets allow spectators to download their tickets, as opposed to waiting for physical tickets to arrive in the mail. These tickets now normally also have a barcode, which may be scanned at turnstile for entry into the park to streamline crowd processing.</p>
								<p class="font-weight-normal">If someone with a membership card also can book a ticket online, the member can just verify his/her reservation with a membership card at the entrance.</p>
					...
					============================================= -->
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="demos/hosting/images/svg/location.svg" class="rounded-0 bg-transparent text-left" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
									
									
									<h3 class="font-weight-medium text-dark"><b>Membership Module</b></h3>
									<p class=" text-dark">Memberships require multiple options and flexibility. Ingressco not only offers this but also includes variations across level of access. These can be easily programmed to match your needs. Send thank you messages and auto reminders to ensure you to retain your membership numbers year on year.  </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
									<img src="demos/hosting/images/svg/team.svg" class="rounded-0 bg-transparent text-left" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
									
									<h3 class="font-weight-medium text-dark"> <b>Offers / Discounts</b> </h3>
									<p class="text-dark">A special Offer / Discount is a marketing term that refers to a unique opportunity for customers to save money or receive a special benefit, product, or service.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								<div class="fbox-icon">
									<img src="demos/hosting/images/svg/balancing.svg" class="rounded-0 bg-transparent text-left" alt="Image" style="height: 52px;">
								</div>
								<div class="fbox-content">
									
									<h3 class="font-weight-medium text-dark"><b>Locker Management</b></h3>
									<p class=" text-dark">Electronic Locking system for lockers give operators complete control over their changing rooms while offering ease of use for customers. And also customers can keep all their belongings in the locker. The same wristband also can be used for Cashless transaction.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Car Parking Billing</b></h3>
									<p class=" text-dark">The system is capable of handling all car parking billing transactions.
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Packages / Combo Deals</b></h3>
									<p class=" text-dark">Create structured packages such as Entry, Food and Merchandise to effortlessly manage reservations and capacity.Offer discounts to groups and families with packaged tickets. Simply decide which tickets you’d like to include, set any discounts or offers, add any limitations, and you are done.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Booking Agents (B2B) Website</b></h3>
									<p class=" text-dark">Allow booking agent’s login to your Website, set their commission rate, set whether they are on account or not. Help them promote your business and report on sales they generate.</p>
		...
		<section id="content">
			<div class="content-wrap">
							...
							<div class="row col-mb-50">
								<div class="col-md-6">
									<ul class="list-group mb-0">
										<li class="list-group-item ">Manage Single as well as Multi-site Desktop POS application</li>
										<li class="list-group-item ">Mobile POS</li>
										<li class="list-group-item ">Handheld POS</li>
										<li class="list-group-item ">Real Time POS Solution & Integrated Wallets</li>
										<li class="list-group-item ">On-Premises.</li>
										<li class="list-group-item ">Robust, Rigid and User-friendly Billing System<br>&nbsp;</li>
									</ul>
								</div>
								...
								<div class="col-md-6">
									<ul class="list-group mb-0">
										<li class="list-group-item ">Real-Time ride wise billing at all locations</li>
										<li class="list-group-item ">Real-time Loyalty & Coupon across all Retail & POS</li>
										<li class="list-group-item ">E-Commerce (B2C & B2M)</li>
										<li class="list-group-item ">Gift Card transactions</li>
										<li class="list-group-item ">Membership Card</li>
										<li class="list-group-item ">Comprehensive and scalable Scheme Engine to define Offers and Promotions</li>
									</ul>
								</div>
				...
				<section id="section-pricing" class="page-section topmargin-lg">
					...
					<div class="heading-block center">
						<h2>Pricing</h2>
						<span>On Cloud Pricing(Excl.Taxes).</span>
					</div>
					...
					<div class="container">
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									<div class="pricing-title">
									<h3>Personal</h3>
										<span style="color:#ffac08;">For getting started</span>
										
									</div>
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>4,999
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i>Minimium No of Licenses <strong>5</strong></li>
											<li><i class="icon-check text-smaller"></i>Ticketing Application</li>
											<li><i class="icon-check text-smaller"></i>Access Control Management</li>
											<li><i class="icon-check text-smaller"></i>Locker Management </li>
											<li><i class="icon-check text-smaller" style="margin-bottom:135px;"></i>MIS Reports<br><br>(Desktop POS application,Mobile App,Handheld Billing) </li>
										</ul>
									</div>
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>5,50,000
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i>Applicable for only one premise <strong></strong></li>
											<li><i class="icon-check text-smaller"></i>One Time Configuration cost for Client & Server (AMC will start after One Year)</li>
											
										</ul>
									</div>
									<div class="pricing-action">
									<a href="#" class="btn btn-lg   bg-transparent" style="color:#ffac08; border: 1px solid #ffac08;">Start Trial</a>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									<div class="pricing-title">
									<h3>Professional</h3>
										<span style="color:#ffac08;">For standard support</span>
										
									</div>
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>6,999
									</div>
								<h3 class="mb-0">Monthly</h3> 
										
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i>Minimium No of Licenses <strong>4</strong></li>
											<li><i class="icon-check text-smaller"></i>Ticketing Application</li>
											<li><i class="icon-check text-smaller"></i>Access Control Management</li>
											<li><i class="icon-check text-smaller"></i>Locker Management </li>
											<li><i class="icon-check text-smaller"></i>Parking Management </li>
											<li><i class="icon-check text-smaller"></i>Rental Billing </li>
											<li><i class="icon-check text-smaller"></i>Merchandise Billing </li>
											<li><i class="icon-check text-smaller" ></i>MIS reports & BI Reports<br><br><br>(Desktop POS application,Mobile App,Handheld Application) </li>
										</ul>
									</div>
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>7,50,000
									</div>
								<h3 class="mb-0">Unlimited</h3> 
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									<div class="pricing-title ">
										...
										<h3>Enterprise</h3>
										<span style="color:#ffac08;">Perfect for enterprises</span>
									</div>
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>8,999 
									</div>
									<h3 class="mb-0">Monthly</h3> 
									
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i>Minimium No of Licenses <strong>3</strong></li>
											<li><i class="icon-check text-smaller"></i>Ticketing Application</li>
											<li><i class="icon-check text-smaller"></i>Access Control Management</li>
											<li><i class="icon-check text-smaller"></i>Locker Management </li>
											<li><i class="icon-check text-smaller"></i>Parking Billing </li>
											<li><i class="icon-check text-smaller"></i>Rental Billing module </li>
											<li><i class="icon-check text-smaller"></i>Merchandise Billing(Inventory)</li>
											<li><i class="icon-check text-smaller" ></i>MIS reports & BI Reports<br><br><br>(Desktop POS application,Mobile App,Handheld Application,Website basic module with PG) </li>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
											<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>9,50,000
									</div>
									<h3 class="mb-0">Unlimited</h3> 
									...
									<div class="pricing-action">
										<a href="#" class="btn btn-lg text-white" style="border:1px solid #ffac08;background-color:#ffac08;">Start Trial</a>
									</div>
								</div>
				...
				<section id="section-services" class="page-section topmargin-lg">
					...
					<div class="heading-block center bottommargin-lg">
						...
						<span>Technical details about Application</span>
					</div>
						...
						<div class="row justify-content-around">
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<h6 class="h5 font-weight-bold mb-2">Solution Types</h6>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<div class="fbox-content">
									<i class="icon-terminal icon-3x"></i>
										<h6 class="h5 font-weight-bold mb-2">Platform</h6>
										<div>WPF (.Net Core 3.1)</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<div class="fbox-content">
									<i class="icon-database icon-3x"></i>
										<h6 class="h5 font-weight-bold mb-2">Database</h6>
										<div>SQL</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-laptop icon-3x"></i>
										<h6 class="h5 font-weight-bold mb-2">Category</h6>
										<div>Sales</div>
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">SAP Integration Certificate(1909)</h3>
											<p class="mt-2">This certificate confirms the technical compliance of GST Compliance Suite
(GCS) 1.0 with SAP certification procedures. </p>
											<a href="#" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">SAP Integration Certificate(1808)</h3>
											<p class="mt-2">This certificate confirms the technical compliance of GST Compliance Suite
(GCS) 1.0 with SAP certification procedures. </p>
											<a href="#" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
		...
		<div class="modal-register mfp-hide" id="modal-contact-publisher">
			<div class="card mx-auto" style="max-width: 1000px;">
			
			

				<div class="card-header py-3 bg-transparent center">
					<h3 class="mb-0 font-weight-normal">Contact Publisher</h3>
					
					<p class=" lead mb-0   "> DevFast Solutions</p>
					<p><img src="images/publisher/df.png" align="center" alt="" width="32" height="32"></p>
					<p class=" lead pt-0 ">Already have an account? <a href="#modal-register" data-lightbox="inline">Log In</a></p>
...
<div class="col-6">
						...
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Email" />
						</div>
						
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Company Name" />
						</div>
							
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="First Name" />	
						
						</div>
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Phone Number" />	
						
						</div>
						
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Last Name" />	
						
						</div>
						
						<div class="col-6 mt-4">
							<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Street Number" />	
	...
	<input type="text" id="login-form-username" name="login-form-username" value="" class="form-control not-dark" placeholder="Phone number" />
						...
						<select class="form-control not-dark">
...
<option value="['Zimbabwe','ZW']">Zimbabwe</option>
						...
						<div class="col-12 mt-4">
							<textarea type="password" id="login-form-password" name="login-form-password" value="" class="form-control not-dark" rows="2" cols="2" placeholder="Message" /></textarea>
						</div>
						<div class="col-12 mt-4">
						<p> <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"> I agree that SAVIC will keep this data with SAVIC Technologies Private Ltd so that they may contact me regarding my request. <a href="Privacy.php">View our Privacy Statement.</p>
						
						</div>
						<div class="col-4 mt-4">
 <button class="button btn-block m-0" id="login-form-submit" name="login-form-submit" value="login">Send Message</button>
						</div>
...
<!---to this--->
	...
	<!--- to this for get it now---->
		...
		<!---this--->
			...
			<!-- Login/Register Modal -->
		<div class="modal-register mfp-hide" id="modal-get-it-now">
			<div class="card mx-auto" style="max-width: 1000px;">
			
			

				<div class="card-header py-3 bg-transparent center">
					<h3 class="mb-0 font-weight-normal">Get it now</h3>
...
<option value="['Zimbabwe','ZW']">Zimbabwe</option>
						...
						<div class="col-12 mt-4">
						<p> <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"> I agree that SAP will share this data with Advantco International LLC so that they may contact me regarding my request. View our Privacy Statement.</p>
 ...
 <button class="button btn-block m-0" id="login-form-submit" name="login-form-submit" value="login">Send Message</button>
				...
				<section id="section-testimonials" class="page-section section parallax light">
	...
	<div class="section m-0">
				...
				<div class="heading-block center">
						...
						<div class="row no-gutters align-items-center p-4 bg-white rounded overflow-hidden flex-md-row shadow-sm position-relative mx-auto" style="max-width: 1000px">
							<div class="col p-4 d-flex flex-column center">
								<h3 class="mb-2" style="color:black;">DevFast Solutions</h3>
								
								<!-- Top Login
							============================================= -->
							<div id="top-account" class="px-4">
								<a href="#modal-contact-publisher" data-lightbox="inline" class="btn btn-primary btn-sm">Contact-Publisher</a>
									<a href="http://devfast.in/"  class="btn btn-primary btn-sm">Publisher website</a>
							</div><!-- #top-search end -->
							
								<a href="http://devfast.in/" class="mt-1"><p>DevFast</p></a>
								<p><img src="images/publisher/df.png" align="center"alt="" width="32" height="32"></p>
							</div>
							<div class="col-auto">
								<img src="demos/crowdfunding/images/credit.jpg" alt="" width="400">
							</div>
						</div>
...
<!-- Mirrored from themes.semicolonweb.com/html/canvas/index-onepage-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2020 07:00:48 GMT -->
</html>