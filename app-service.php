...
<body class="stretched sticky-responsive-pagemenu">
	...
	<?php include('css/header/header.php')?>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Implementation Services</div>
		...
		<section id="slider" class="slider-element slider-parallax include-header min-vh-100" style="background: url('images/landing/landing3.jpg') no-repeat; background-size: cover">
						...
						<div class="heading-block mb-0 center">
							<h1>
								<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
									Implementation Services <span class="t-rotate">Simple|Customizable|Flexible|Easy|Profitable</span>
								</span>
							</h1>
							<span class="d-none d-md-block">Our end-to-end implementation services help you design, deploy, and adopt SAP solutions faster and with lower risk.</span>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>SAP Value Assurance</b></h3>
									<p class=" text-dark">Deploy a systematic approach to accelerate your customer- or partner-led implementation on premise, in the cloud, or through a hybrid approach with less risk and reduced cost. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>Continuous Performance Management</b> </h3>
									<p class="text-dark">Provide your employees with ongoing feedback and coaching so they perform at their best.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>SAVIC Advanced Deployment</b></h3>
									<p class=" text-dark">Leverage end-to-end turnkey services to simplify and accelerate your deployment of SAP S/4HANA with services from SAP as your primary partner and project lead.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Data Management and Landscape Transformation</b></h3>
									<p class=" text-dark">Turn data into profit faster by feeding your business applications and processes with the data essential for the digital economy.
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Goals Management</b></h3>
									<p class=" text-dark">Combine goal alignment, visibility, and accountability reports to keep managers up-to-date on their employees' progress to meet business objectives</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Cloud Professional Services</b></h3>
									<p class=" text-dark">Use flexible, value-driven expertise to craft a road map, execute migration, and manage your hybrid or cloud infrastructure securely.</p>
