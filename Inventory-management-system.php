...
<body class="stretched sticky-responsive-pagemenu">
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Inventory Management System</div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
									<a href="https://www.youtube.com/watch?v=5h9qLcHB_94?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
									<img src="demos/business/images/sections/inventory.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Inventory Management System</h3>
								</div>
								<p class="font-weight-normal">As a part of supply chain, inventory management includes aspects such as controlling and overseeing purchases — from suppliers as well as customers — maintaining the storage of stock, controlling the amount of product for sale, and order fulfilment.</p>
								<p class="font-weight-normal">Naturally, company’s precise inventory management meaning will vary based on the types of products you sell and the channels you sell them through. But as long as those basic ingredients are present, you’ll have a solid foundation to build upon.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Inventory Optimization </b></h3>
									<p class=" text-dark">Maintain just the right amount of inventory for each product, without over- or under-stocking any item  </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>Stock Notifications </b> </h3>
									<p class="text-dark">Receive alerts and notifications when there’s over- or under-stocking beyond a defined threshold 
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Multi-location Support </b></h3>
									<p class=" text-dark">Manage multiple warehouses and point-of-sale (POS). All locations can be integrated into a single inventory management system</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Custom Reports</b></h3>
									<p class=" text-dark">Enables you to manage items in your inventory that have not reached the sales levels you expected, for example, by offering discounts on them </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Purchase order records</b></h3>
									<p class=" text-dark">Easily identify which products are in demand, both perpetually and seasonally, and prepare to meet your customers’ needs</p>
	...
	<li><i class="icon-check text-smaller"></i> <strong>Masters</strong> Purchase Requisition (PR)</li>
	<li><i class="icon-check text-smaller"></i> Purchase Order</li>
	<li><i class="icon-check text-smaller"></i> Goods Return Note(GRN)</li>
	<li><i class="icon-check text-smaller"></i> Purchase Return</li>
	<li><i class="icon-check text-smaller"></i> Stocker Transfer  Issue </li>
	
	<li><i class="icon-check text-smaller"></i> Standard Reports</li>
	<li><i class="icon-check text-smaller"></i> Stock valuation on FIFO</li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<h3>Professional</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>2,999
									</div>
								<h3 class="mb-0">Monthly</h3> 
	...
	<li><i class="icon-check text-smaller"></i> Stocker Transfer  Issue </li>
	<li><i class="icon-check text-smaller"></i> Standard Reports</li>
	<li><i class="icon-check text-smaller"style="margin-bottom:15px;"></i> Stock valuation on FIFO</li>
	<br>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>1,99,000
									</div>
								<h3 class="mb-0">Unlimited</h3> 
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>3,999 
									</div>
									<h3 class="mb-0">Monthly</h3> 
...
<li><i class="icon-check text-smaller"></i>Minimium No of Licenses <strong>5</strong></li>									
<li><i class="icon-check text-smaller"></i><strong> Masters </strong> Purchase Requisition</li>
<li><i class="icon-check text-smaller"></i> Purchase Order</li>
<li><i class="icon-check text-smaller"></i> Goods Return Note<strong>(GRN)</strong></li>
<li><i class="icon-check text-smaller"></i> Purchase Return</li>
<li><i class="icon-check text-smaller"></i>Stocker Transfer</li>
<li><i class="icon-check text-smaller"></i> Issue & MIS & BI Reports</li>
<li><i class="icon-check text-smaller"></i> POS Billing</li>
<li><i class="icon-check text-smaller"></i> Online PR & PR status</li>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
											<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>2,99,000
									</div>
									<h3 class="mb-0">Unlimited</h3> 
							...
							<div class="row col-mb-30">
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">AMUZE</h3>
											<p class="mt-2">Selling your products in multiple places should be every bit as simple as selling  in one. 
 </p>
											<a href="https://www.savictech.com/Demo-app-Center/images/pdf/Ticketing%20PPT%2025-11-20.pdf" target="_blank" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">Used Ingressco instead of Amuze</h3>
											<p class="mt-2"> Ingressco is a
unified platform that can run your business with ease so you can have a one-stop-shop for all
types of ticketing.  </p>
											<a href="https://www.savictech.com/Demo-app-Center/images/pdf/TICKETING%20Benefits%20&%20Features.pdf" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
