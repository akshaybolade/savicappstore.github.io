...
.fbox-content h3{font-size:1rem;font-weight:600;font-family:Poppins,sans-serif;margin-bottom:0;color:#333}
	...
	<?php include('css/header/header.php')?>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">GST Digital App</div>
		...
		<section id="content">
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-md clearfix" >
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=zViuqVv7YiU?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/gst-app.jpg" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">GST Digital App</h3>
								</div>
								<p class="font-weight-normal">SAVIC’s GST Digital App is one stop shop to validate and check for all GST related issues like GSTIN Validation, Check vehicle details, Generate e-Way Bill, get and print e-Way Bill, update or extend e-Way Bill, Create e-Invoice, View/Print e-Invoice, Cancel e-Invoice. </p>
									<p class="font-weight-normal">App helps users with the same SAP Screen where they are comfortable and easy to navigate screens to get details before proceed with Sales invoices. </p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>One Stop Shop for GST</b></p>
									<p class=" text-dark">All GST related validations can be perfomed before generating Sales Invoice document. Validations like, GSTIN is valid or not, filing status of the GSTIN, Distance between two postal codes, provided vehicle details are valid or not and etc., We use API's from the Goverment authorized GSP's. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"> <b>e-WayBill</b> </p>
									<p class="text-dark">Under the e-WayBill system, manufacturers, traders and transporters can generate e-WayBills for the goods transported from the place of its origin to its destination on a common portal with ease. Tax authorities are also benefited as this system has reduced time at check -posts and helps reduce tax evasion.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>e-Invoice</b></p>
									<p class=" text-dark">This system requires large businesses with an annual aggregate turnover of more than Rs.100 crore to comply with some requirements.
They must obtain a unique invoice reference number for every business-to-business invoice by uploading on the GSTN portal known as the invoice registration portal.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<p class="font-weight-medium text-dark"><b>App Security	</b></p>
									<ul>
									<li class=" text-dark">GSTIN portal is accessed through highly Secured API's</li>
	<li class=" text-dark"> GSP service the request from SAP by connecting to GSTN portal exposed to cloud</li>
	<li class=" text-dark"> GST Suvidha Provider(GSP) is an exclusive entity authorized to enable a platform for businesses, accounting professionals, and taxpayers to access GST portal services</li>
</ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Simple Integration</b></p>
									<ul>
									<li class=" text-dark">Integrated system will avoid duplication / double-entry of sales details in two systems.</li>
<li class=" text-dark"> Faster e-Way Bill generation and elimination of mistakes.</li>
<li class=" text-dark"> Single interface for Sales/Billing team to verify GST details and initiate corrective action.</li>
</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Deployment</b></p>
									<ul>
									<li class=" text-dark">Quickly can be deployed in 20-24 days</li>
<li class=" text-dark">Flexible and competitive pricing</li>
<li class=" text-dark"> Easy to choose either of the components (GST, e-WayBill, e-invoicing).</li>
					</ul>			
								</div>
							</div>
						</div>
					...
					<div class="container">
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4  text-center text-md-center " style="border:1px solid #ffac08;" >
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>GST Functionality only</strong> Access</li>
											<li><i class="icon-check text-smaller"></i>Up to <strong>5,000 </strong> API Calls</li>
											<li><i class="icon-check text-smaller"></i> Validate GSTIN Number </li>
											<li><i class="icon-check text-smaller "></i> GSTIN Filing Status</li>
											<li><i class="icon-check text-smaller "></i> Vehicle Number Validation</li>
											<li><i class="icon-check text-smaller "></i>Distance Between Two postal codes </li>
												...
												<i>* Contact our sales team for one time cost details</i>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<h3 class="mb-0">Monthly</h3> 
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i>Up to  <strong> 10,000</strong> API Calls</li>
											
											<li><i class="icon-check text-smaller"></i> <strong>Extended</strong> Access</li>
											
											<li><i class="icon-check text-smaller"></i> <strong>e-WayBill </strong> Creation/Print</li>
											<li><i class="icon-check text-smaller "></i> <strong>Extend </strong> e-WayBill</li>
											<li><i class="icon-check text-smaller" ></i> <strong>Cancel </strong> e-WayBill</li>
											<li><i class="icon-check text-smaller "></i><strong>1 year </strong> License</li>
												<li><i class="icon-check text-smaller " style="padding-bottom:40px;"></i><strong>24/7</strong> Support</li>
												<i>* Contact our sales team for one time cost details</i>
										</ul>
									</div>
									<div class="pricing-action">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>14,999 
									</div>
									<h3 class="mb-0">Monthly</h3> 
									
									<div class="pricing-features">
									<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i>Up to  <strong> 15,000</strong> API Calls</li>
											
											<li><i class="icon-check text-smaller"></i> <strong>Full</strong> Access</li>
											
											<li><i class="icon-check text-smaller"></i> <strong>Generate</strong> e-Invoice</li>
											<li><i class="icon-check text-smaller " ></i> <strong>View/Print </strong> e-Invoice</li>
											<li><i class="icon-check text-smaller " ></i> <strong>Cancel </strong> e-Invoice</li>
											<li><i class="icon-check text-smaller "></i><strong>1 year </strong> License</li>
												<li><i class="icon-check text-smaller " style="padding-bottom:40px;"></i><strong>24/7</strong> Support</li>
												<i>* Contact our sales team for one time cost details</i>
										</ul>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-database icon-3x"></i>
										<h6 class="h5 font-weight-bold mb-2">API</h6>
										<div>Government authorized GSP</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="row col-mb-30">
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">SAVIC GST Solution Centre</h3>
											<p class="mt-2"> GST Implementation is around the corner and companies waiting for the government’s final decision on GST rollout.  </p>
											<a href="images/pdf/GST Hand book.pdf"  class="btn btn-link mt-3 font-weight-normal color p-0 " style="font-size: 16px;"  target="_blank">Read pdf <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										<div class="fbox-media">
											<img src="demos/hosting/images/svg/location.svg" style="width: 42px;" alt="Image" target_blank="">
										</div>
										<div class="fbox-content px-0">
											<h3 class="ls0">SAP S/4HANA
Your trusted partner in the GST journey</h3>
											<p class="mt-2">All of the needs are part of the inbuilt capabilities of SAP S/4HANA to
accelerate the journey of GST Implementation by businesses. </p>
											<a href="images/pdf/GST Corporate brochure.pdf" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;" target="_blank">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
		...
		<div class="modal-register mfp-hide" id="modal-contact-publisher">
			<div class="card mx-auto" style="max-width: 1000px;">
				...
				<div class="card-header py-3 bg-transparent center">
					...
					<p class=" lead mb-0   "> SAVIC Technologies Private Ltd.</p>
					<p><img src="images/publisher/logo-light.png" align="center" alt="" width="82" height="32"></p>
...
<option value="['Zimbabwe','ZW']">Zimbabwe</option>
						...
						<div class="col-12 mt-4">
						<p> <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"> I agree that SAVIC will keep this data with SAVIC Technologies Private Ltd so that they may contact me regarding my request. <a href="Privacy.php">View our Privacy Statement.</a></p>
	...
	<!--- to this for get it now---->
		...
		<div class="modal-register mfp-hide" id="modal-get-it-now">
			<div class="card mx-auto" style="max-width: 1000px;">
				...
				<div class="card-header py-3 bg-transparent center">
					<h3 class="mb-0 font-weight-normal"><span>Get it now<span></h3>
				...
				<div class="heading-block center">
						...
						<div class="row no-gutters align-items-center p-4 bg-white rounded overflow-hidden flex-md-row shadow-sm position-relative mx-auto" style="max-width: 1000px">
							<div class="col p-4 d-flex flex-column center">
								<h3 class="mb-2" style="color:black;">SAVIC Technologies Private Ltd.</h3>
							...
							<div id="top-account" class="px-4">
								<a href="#modal-contact-publisher" data-lightbox="inline" class="btn btn-primary btn-sm">Contact-Publisher</a>
									<a href="https://www.savictech.com/"  class="btn btn-primary btn-sm">Publisher website</a>
							</div><!-- #top-search end -->
							
								<a href="https://www.savictech.com/" class="mt-1"><p>SAVIC</p></a>
								<p><img src="images/publisher/logo-light.png" align="center"alt="" width="82" height="32"></p>
							</div>
							<div class="col-auto">
