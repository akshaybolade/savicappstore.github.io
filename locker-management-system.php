			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Locker Management System</div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
						<a href="https://www.youtube.com/watch?v=pOpwXaKY7N4?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/locker-management.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Locker Management System</h3>
								</div>
								<p class="font-weight-normal">With Amuze locker management software, administrators have the option to easily change configurations, assign lockers, view detailed usage data, see in real-time which lockers are in use, and schedule synchronization and notification tasks.   To streamline operations, the locking system can be integrated with any ID card system.
Organizations can provide locker rentals via their online portal and increase security with a networked alarm.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Track & secure</b></h3>
									<p class=" text-dark">Our locker management system has built-in burglary monitoring, and audit trail capabilities so you know when items are delivered, and who accessed the locker. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>Save Money</b> </h3>
									<p class="text-dark">Eliminate maintenance costs associated with managing keys, assigning lockers, and the pain of managing package delivery. Our flexible system will free up time and resources for your staff.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">Electronic Locking system for lockers give operators complete control over their changing rooms while offering ease of use for customers.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Flexibility</b></h3>
									<p class=" text-dark">A locker system that works for almost any setting — libraries, offices, package delivery, retail. Smart package management, easy locker assignments for personnel, and integration with third party systems.
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Simple to Operate</b></h3>
									<p class=" text-dark">Both users and operators will benefit from how easy the system is to use. There are no PINs to remember, no mechanical keys to inventory or replace, to locks to change or manage. Lost credentials for a user’s locker can be found on the locker terminal, keeping locker management to a minimum.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Dynamic promotions</b></h3>
									<p class=" text-dark">LMS is a desktop solution for managing end-to-end Locker Operations including Rent management and auto communications for external customers.</p>
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i> Masters
<li><i class="icon-check text-smaller"></i> POS Billing</li>
<li><i class="icon-check text-smaller"></i> Locker integration</li>
<li><i class="icon-check text-smaller"></i> Lost Locker management</li>
<li><i class="icon-check text-smaller"></i> Inventory management</li>
...
<li><i class="icon-check text-smaller"></i>Minimium <strong>10</strong> Users</li>
...
<li><i class="icon-check text-smaller"></i>Standard Reports</li>
<li><i class="icon-check text-smaller"></i><strong>4 GB</strong> space allocated</li>
<li><i class="icon-check text-smaller"></i>Minimium <strong>20</strong> Users</li>
											<li><i class="icon-check text-smaller"></i><strong>6</strong> Months Contract </li>
											<li><i class="icon-check text-smaller" style="margin-bottom:135px;"></i><strong>24/7</strong> Support</li>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>1,299 
									</div>
									<h3 class="mb-0">Monthly</h3> 
...
<li><i class="icon-check text-smaller"></i>Standard Reports</li>
<li><i class="icon-check text-smaller"></i><strong>4 GB</strong> space allocated</li>
<li><i class="icon-check text-smaller"></i>Minimium <strong>30</strong> Users</li>
