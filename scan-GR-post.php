...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Scan and Post Goods Receipt</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Scan and Post Goods Receipt</div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-md clearfix" >
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=9hc3AWstc3E?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/scan-to-GR.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Scan and Post Goods Receipt</h3>
								</div>
								<p class="font-weight-normal">One more challenge in enterprises is Goods Receipt as it is manual.  Warehouse/Storage location receive more than 500 units of goods either from vendors, production, sub-contracting, or in any other way almost  a couple of days in a week. It is very time consuming to the clerk to note down every item with quantity and post it in ERP.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Goods Receipt(GR) Against PO</b></p>
									<p class=" text-dark">You can open the app with login pin or Biometric (Thumb). Just scan the QR code which consists of PO number, Material, Quantity and Unit of measure.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"> <b>No Additional Cost</b> </p>
									<p class="text-dark">Normally QR Code reader/ RF Gun costs good amount of money and need more devices depending on the size of warehouse or volume or moving goods and these are exepensive too. 
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Quicker and Faster</b></p>
									<p class=" text-dark">Noting down entry of goods manually takes huge amount of time. It makes trucks waiting for longer hours outside the gate. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<p class="font-weight-medium text-dark"><b>APPS EASY TO USE</b></p>
									
									<p class=" text-dark">SAVIC App Center provides SAVIC and their partner apps that helps extend boost your business services. Mobile Apps are very easy to use can be accessed from any Android/ios smartphone, and Tablet.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Key Benefits</b></p>
									<ul>
									<li class=" text-dark">No need to purchase any specific Device other than smartphone</li>
									<li class=" text-dark">Clerks smartphone is enough to push the App</li>
									<li class=" text-dark"> App can be deployed to multiple devices(phones/tablet)</li>
									<li class=" text-dark">Can go for On & Off mode</li>
									<li class=" text-dark">Uses SAP REST API functionality to do this activity</li>
									</ul>			
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<ul>
									<li class=" text-dark">Quickly can be deployed at maximum of  3-4 weeks
<li class=" text-dark">Flexible and competitive pricing based on the option</li>
<li class=" text-dark"> No additional Hardware, Infrastructure, resources required Real-time GR posting</li>
<li class=" text-dark"> System must be enabled to use HTTP and HTTPS protocals</li>
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4  text-center text-md-center " style="border:1px solid #ffac08;" >
									...
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>2,25,000<sup>*</sup>
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>Goods Receipt Only</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Install in one or more Smartphone/Tablet</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>1 Months Support</strong></li>
											...
											<li></li><li></li>
											<li></li>
											<i>* Smartphone/Tablet with Camera is Must</i>
											<i>* Price is one time payment only</i>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center " style="border:1px solid #ffac08;">
									...
									<h3>Gold</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>4,25,000<sup>*</sup>
									</div>
								 
										
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>Goods Receipt</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Goods Issue</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Install in one or more Smartphone/Tablet</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>1 Months Support</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>24/7 Support</strong></li>
											<li></li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>6,00,000<sup>*</sup>
									</div>
									...
									<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>Goods Receipt</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Goods Issue</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Generate QR Code</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Install in one or more Smartphone/Tablet</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>1 Months Support</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>24/7 Support</strong></li>
						...
						<div class="row justify-content-around">
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<h6 class="h5 font-weight-bold mb-2">Runs on</h6>
										<div>Mobile/Tablet
