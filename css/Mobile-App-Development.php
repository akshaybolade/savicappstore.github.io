						...
						<div class="heading-block mb-0 center">
							<h1>
								<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
									Mobile App Development<span class="t-rotate"></span>
								</span>
							</h1>
							<span class="d-none d-md-block">We Develop native and hybrid mobile apps as per customer need. We extensively focus on UX-UI and deliver customer expectations. </span>
						</div>
					...
					<div class="row col-mb-50">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h3>UX/UI Design</h3>
									<p>The success of app depends on it's look and experience that delivers. It doesn't matter how your innovative idea it is, UX/UI play a key role in overall experience it offers to end users.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p>We offer end to-end and cost-effective versatile Android application development administrations to our worldwide customer base. Android provides its SDK free to the developer community that lower down development and licensing cost.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p>We offer rigorous security measures for iOS app development to provide a strong shield for malware and virus. This makes a perfect iOS app for your business. 
</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h3>Hybrid App Developmentn</h3>
									<p>The hybrid app development services makes the complete process of development faster and cheaper by sharing the same code for different OS. It assists the businesses to diminish upgraded costs time-to-market and to attain more users and followers without deteriorating the quality. </p>
								</div>
							</div>
						</div>
