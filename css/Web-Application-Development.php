...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element slider-parallax include-header min-vh-100" style="background: url('images/landing/landing1.jpg') no-repeat; background-size: cover">
						...
						<div class="heading-block mb-0 center">
							<h1>
								<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
									Web Application Development<span class="t-rotate"></span>
								</span>
							</h1>
							<span class="d-none d-md-block">The quality and features of a website gives the first impression for any organization. In today's world business can develop and become simpler, and achieve objectives much faster by using web applications. We have pool of experts with skillset Angular JS, ASP.Net, React Web, PHP, Java Script, Node JS and others. We are experts in building website Portals/eCommerce platforms on Cloud.</span>
						</div>

							<a href="#modal-register" data-lightbox="inline" class="button button-border button-light button-rounded button-reveal text-right button-large topmargin d-none d-md-inline-block"><i class="icon-angle-right"></i><span>Request-demo</span></a>
					...
					<div class="row col-mb-50">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p>PHP is amongst the most extensively used web programming language by the web developer. PHP is like a cherry on the cake to the era of technologies. It is free & open source technology. As a server-side scripting language, it is capable of rendering dynamic pages & apps. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h3>Angular JS</h3>
									<p>AngularJS is an open source Javascript framework, largely maintained by the engineers at Google. This front end framework has gained immense popularity and has become the go-to framework for developing Single Page Applications. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p>Give a world-class web experience to your customers with our unmatched web design and development services. We understand the need for scalable solutions for simplifying complex business challenges. 
</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h3>e-Commerece applications</h3>
									<p>You may currently have an office or store, which oversees all your business operations and the distribution of your products to customers. However if you are wanting to find ways to increase your sales quicker, reduce your business operating costs and increase profit margins for your business then an e-commerce portal is an effective way forward for you. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p>Combine goal alignment, visibility, and accountability reports to keep managers up-to-date on their employees' progress to meet business objectives</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h3>Cloud Professional Services</h3>
									<p>Use flexible, value-driven expertise to craft a road map, execute migration, and manage your hybrid or cloud infrastructure securely.</p>
								</div>
							</div>
						</div>
					</div>
...
<div class="heading-block center">
						...
						<div class="col-md-6 col-lg-8">
							<div id="snav-content1">
								<div class="heading-block">
									<h3>Consulting Services for R&D Engineering</h3>
							...
							<div id="snav-content2">
								<div class="heading-block">
									<h3>Automotive Industry Consulting Solutions</h3>
							...
							<div id="snav-content3">
								<div class="heading-block">
									<h3>High Tech Industry Consulting Services</h3>
					...
					<div class="heading-block">
								...
								<p>Read why SAP was named as a leader in the IDC MarketScape: Worldwide SAP Next-Generation Implementation Services 2020 Vendor Assessment.</p>
