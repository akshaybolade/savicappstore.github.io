...
<body class="stretched sticky-responsive-pagemenu">
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">SAVIC T&E </div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-md clearfix" >
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=BV37eRvQWEU?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
									
									<img src="demos/business/images/sections/SAVIC-T&E.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">SAVIC T&E </h3>
								</div>
								<p class="font-weight-normal">Business expansion, mobility and globalization contribute to increased travel expenses for many organizations. When it comes to business the major cost goes on travel and expenses. <br>By combining T&E into one solution, organizations can automate processes and capture employee spend in one place. And if you want to manage all that money effectively, you need a solution that’s truly integrated into your travel program.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Data With No Paper Receipts</b></h3>
									<p class=" text-dark">Not only can your users book airfare, hotels and cars from their mobile device, they can take a photo of their receipt to automatically and accurately populate their expense reports.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>STAY IN COMPLIANCE</b> </h3>
									<p class="text-dark">SAVIC Travel and Expense, compliance is automatic. Your expense policies are incorporated into the process,and out-of-policy spending is flagged before violations occur—no matter which booking channel travelers use.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>INSIGHTS INTO THE RIGHT DATA</b></h3>
									<p class=" text-dark">SAVIC Intelligence gives budget managers, the finance team and executives the actionable analytics and proactive insight to easily manage spending as and before it happens. </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>APPS EASY TO USE	</b></h3>
									<p class=" text-dark">SAVIC App Center provides partner apps and services that extend the value of SAVIC Travel and Expenses solution. Mobile Apps are very easy to use can be accessed from mobile, Tablet and Web.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Key Benefits</b></h3>
									<p class=" text-dark">Better user experience, make smarter data-driven decisions with a complete spend picture, save time by flowing booking data into expense reports automatically, start Trip, Add receipt, Stop trip and submit for approval, simplify budgeting, forecast more accurately, and improve vendor negotiations</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">Quickly can be deployed at maximum of  4 weeks, flexible and competitive pricing, a cloud based solution hence no worry on Hardware, Infrastructure, resources, no worry on back-ups and Disaster Recovery, can be integrated with your Enterprise Software with plugins</p>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4  text-center text-md-center " style="border:1px solid #ffac08;" >
									...
									<div class="pricing-price">
									 ...
									 <h3 class="mb-0">Per User/Month</h3> 
										
									
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>50 Users</strong></li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go <strong></strong></li>
											<li><i class="icon-check text-smaller"></i> Start anytime</li>
											<li><i class="icon-check text-smaller "></i> Stop anytime</li>
											<li><i class="icon-check text-smaller "></i> 24/7 Support</li>
											<li></li>
											<li></li>
											<li></li>
											<i>* One time setup charges are additional</i>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center " style="border:1px solid #ffac08;">
									...
									<h3>Gold</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>249 
									</div>
								<h3 class="mb-0">Per User/Month</h3> 
										
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i>


  <strong>50+ Users </strong></li>
											
											<li><i class="icon-check text-smaller"></i> <strong>Pay-as-you-go</strong> </li>
											
											<li><i class="icon-check text-smaller"></i> <strong>Start anytime </strong> </li>
											<li><i class="icon-check text-smaller "></i> <strong>Stop anytime </strong> </li>
											<li><i class="icon-check text-smaller" ></i> <strong>24/7 Support </strong></li>
											<li></li>
											<li></li>
											<li></li>
											<i>* One time setup charges are additional</i>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>2739  
									</div>
									<h3 class="mb-0">Per User/Year</h3> 
  ...
  <strong>50+ Users </strong></li>
											...
											<li><i class="icon-check text-smaller"></i> <strong>Start anytime </strong> </li>
											<li><i class="icon-check text-smaller "></i> <strong>Stop anytime </strong> </li>
											<li><i class="icon-check text-smaller" ></i> <strong>1 Year Contract</strong></li>
											<li><i class="icon-check text-smaller" ></i> <strong>24/7 Support </strong></li>
												<i>* One time setup charges are additional</i>
										</ul>
									</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-terminal icon-3x"></i>
										...
										<div>Hybrid Mobile App to run on both Android & iOS</div>
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											...
											<p class="mt-2"> GST Implementation is around the corner and companies waiting for the government’s final decision on GST rollout.  <br><br>&nbsp;</p>
