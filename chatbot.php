...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Chatbot | Savic app center</title>
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element slider-parallax include-header min-vh-100" style="background: url('images/landing/chatbot.jpg') no-repeat; background-size: cover;opacity: 0.9;">
						...
						<div class="heading-block mb-0 center">
							<h1 class="text-white">
								<span class="text-rotater nocolor" data-separator="|" data-rotate="flipInX" data-speed="3500">
									Improve your productivity by the implementation of chatbots
								</span>
							</h1>
							<span class="d-none d-md-block text-white">Sounds like science-fiction, a human-like dialog with the SAP system? Well, actually, this is possible right now through chatbots and conversational AI!.</span>
						</div>
...
<section id="content">
				...
				<div class="section m-0 clearfix" style="background-color: #eef2f5;">
					<div class="container clearfix">
						...
						<span>Information</span>
							...
							<p class="font-weight-heavy d-none d-md-block" style="font-size: 16px; opacity: .9; ">Easily integrate Chatbot AI with your current ecosystem with SAVIC's AI-Driven industry specific Chatbots. Link and simplify end to end customer journeys for your CRMs and other applications Chats for any organization. Transform your business with our experts with deep understanding and bots development process. Revolutionize the consumer and employee interface for the company with AI Chatbots. Improve the staff and consumer's experience by creating and delivering efficient interfaces for conversation. Manage HR, procurement or travel activities effectively by using an end-to-end bot construction infrastructure and an enterprise digital assistance. Take advantage of complete integration of SAP tech goods. </p>
						</div>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="heading-block center">
							<h2>Key Features of SAVIC Chatbot Development</h2>
					...
					<div class="row col-mb-50">
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h4>FTP Integration</h4>
									<p class="text-dark">Majority of digital systems have connected via File Transfer Protocol(FTP) integration. In this one system exports data in file format in a shared and protected location.
									</p>
								</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									...
									<p class="text-dark">Middleware is a software that links two or more separate applications or systems. Data flow can be real time or near real time depending on the scenario. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-border fbox-effect">
								...
								<div class="fbox-content">
									<h4>SOAP</h4>
									<p class="text-dark">Simple Object Access Protocol (SOAP) is a messaging protocol uses XML file to exchange structured information between system.Expressing complex methods is generally easier with SOAP and it is better suited for the enterprise.
</p>
								</div>
							</div>
						</div>
