...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>SAP Integration with Salesforce</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">SAP Integration with Salesforce</div>
			...
			<div class="content-wrap">
				...
				<div class="row topmargin-md clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=dP5bSAGCVc8" data-lightbox="iframe">
									<img src="demos/business/images/sections/SAP-SALESFORCE.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 40%; left: 50%; font-size: 60px; color: #CCC; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">SAP 
Integration with Salesforce</h3>
								</div>
								<p class="font-weight-normal">Salesforce is cloud based CRM and SAP is a strong ERP package. Most organizations use both of these to boost their ROI. </p>
					...
					============================================= -->
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Effective Data Management</b></h3>
									<p class=" text-dark">Any master data like Customer gets created in Salesforce(SFDC), it is available for Financials and various business functions in SAP. Similarly any material gets created in SAP it will be available to leverage or refence to proceed with business functions in SFDC. Automated process helps reduce manual efforts and increased effeciency. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Real-time and reduced errors</b></h3>
									<p class=" text-dark">SAP integration with SFDC helps eliminate the need of dual data entry thus saving user's time and acute cost and  invoice generation for customers. This real-time integration helps reduced redundancies and errors as those very common in manual data entry.</p>
								</div>
							</div>
						</div>
							...
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Process orders in Real-time</b></h3>
									<p class=" text-dark">The corresponding Sales order details automatically gets placed in SAP as and when a new opportunity gets closed in Salesforece CRM. This is achieved instantly and also helps you to estimate any related cost. Hence this makes the entire opportunity-to-order process optimized.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Accelerate cash flow</b></h3>
									<p class=" text-dark">SAP integration with SFDC has proved to easily identify as well as send alerts when overdue accounts are recognized to help businesses optimize the cash flow system. As a result, this makes finance department to recognize revenue sooner and by achieving its monthly financial close at a faster rate.
							...
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Boost ROI</b></h3>
									<p class=" text-dark">As you begin to leverage the number of functionalities by integrating the Salesforce platform with SAP, it is proven to make your business process effective by providing cloud-based agility around your entire business system environment
							...
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Deployment</b></h3>
									<p class=" text-dark">Quickly can be deployed in maximum of  3-4 weeks,Master data and Transactional data replication and automation
,User must have access to SAP system and to Salesforce system as well
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									<div class="pricing-title text-center text-md-center">
									<h3>Personal</h3>
										<span style="color:#ffac08;">For getting started</span>
										
									</div>
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price text-center text-md-center">
										<span class="price-unit">&#x20B9;</span>75,000
									</div>
									 <h3 class="mb-0 text-center text-md-center">Per Inteface</h3> 
										
									
									<div class="pricing-features">
										<ul class="iconlist" >
											<li><i class="icon-check text-smaller "></i> <strong>Master </strong> Data</li>
											<li><i class="icon-check text-smaller"></i>Transactional Data</li>
											<li><i class="icon-check text-smaller"></i> <strong> Inbound or Outbound</strong></li>
											<li><i class="icon-check text-smaller"></i> <strong>2 </strong>Months support</li>
											<li><i class="icon-check text-smaller"></i> <strong>24/7</strong> Support</li>
											<li><strong>*</strong> Interface is either Inbound or Outbound</li>
											<li><strong>*</strong> End to-end interface for single transaction</li>
											
											<li><br><br></li>
											
										</ul>
									</div>
									<div class="pricing-action text-center text-md-center">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<h3>Professional</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price text-center text-md-center">
										<span class="price-unit">&#x20B9;</span>N/A
									</div>
								<h3 class="mb-0 text-center text-md-center">Monthly</h3> 
										
									<div class="pricing-features" >
										<ul class="iconlist">
										<li><i class="icon-check text-smaller "></i> <strong>10 </strong> Users</li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go</li>
											<li><i class="icon-check text-smaller"></i> <strong>100 MB </strong>space allocated</li>
											<li><i class="icon-check text-smaller"></i> <strong>6 </strong> Months Contract</li>
											<li><i class="icon-check text-smaller"></i> <strong>24/7</strong> Support</li>
											<li><br><br></li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price text-center text-md-center">
										<span class="price-unit mb-0">&#x20B9;</span>N/A
									</div>
									<h3 class="mb-0 text-center text-md-center">Per User/Month</h3> 
									
									<div class="pricing-features" >
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>10+ </strong> Users</li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go</li>
											<li><i class="icon-check text-smaller"></i> <strong>150 MB </strong>space allocated</li>
											<li><i class="icon-check text-smaller"></i> <strong>1 </strong> Year Contract</li>
											<li><i class="icon-check text-smaller"></i> <strong>24/7</strong> Support</li>
											<li><br><br></li>
										</ul>
									</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-terminal icon-3x"></i>
										...
										<div>ECC, ECC on HANA, Salesforce</div>
									</div>
								</div>
							</div>
							...
							<div class="row col-mb-30">
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">Whatsapp for Business</h3>
											<p class="mt-2"> Now save time with Expand ERP and communicate faster with our newest integrated features. </p>
											<a href="https://www.savictech.com/whatsapp-integration.php"  class="btn btn-link mt-3 font-weight-normal color p-0 " style="font-size: 16px;"  target="_blank">Learn More <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h3 class="ls0">Leverage WhatsApp for Business with SAP</h3>
											<p class="mt-2">It is undeniable that WhatsApp is quickest and most widely used communication tool Globaly. </p>
											<a href="images/pdf/SAVIC WhatsApp Integration with SAP 2 page brochure.pdf" class="btn btn-link mt-3 font-weight-normal color p-0" style="font-size: 16px;" target="_blank">Read PDF <i class="icon-line-arrow-right position-relative" style="top: 2px"></i></a>
										</div>
									</div>
								</div>
