			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Generate-QR-Code</div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-md clearfix" >
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
									<a href="https://www.youtube.com/watch?v=uYmm9IAcgzA?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/generate-qr-code.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Generate-QR-Code</h3>
								</div>
								<p class="font-weight-normal">One more challenge in enterprises is Goods movement. Warehouse/Storage location receives and issues goods either to customers,Vendors, production, sub-contracting, or in any other almost on daily. It is very time consuming to the clerk to note down every item and post it in ERP.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="font-weight-medium text-dark"><b>Generate QR Code</b></p>
									<p class=" text-dark">You can select relevant materials and quantity with unit of measure to generate QR code and print lablel for faster goods movement. A program will help generate labels based on the material type you select on selection screen or based on your business need.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class="text-dark">The solution is implemented in SAP, the look and feel is as same as any other SAP screen. There will be very minimal or no end user training is required. This solution doesn't need any additional hardware or infrastructure hence the additional cost is almost zero.
</p>
								</div>
							</div>
						</div>
...
<li class=" text-dark"> User must have access to SAP system and a label printer must be connected</li>
