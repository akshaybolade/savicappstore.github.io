...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Whatsapp-integration with ERP</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">WhatsApp Integration with ERP</div>
			...
			<div class="content-wrap">
				...
				<div class="row topmargin-md clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/embed/PrMPIbxfnz4?rel=0&amp;showinfo=0" data-lightbox="iframe">
									<img src="demos/business/images/sections/whatsapp-integration.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 50%; left: 50%; font-size: 60px; color: green; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h4 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">WhatsApp Integration with ERP</h4>
								</div>
								<p class="font-weight-normal">Helps improvise relationship with customers in the digital Age. Keep your customers updated with order notifications, shipping alerts, product demonstration videos. Finally it helps take your business communications to a whole new level of engagement. No specific training is needed since your customer is already in WhatsApp. </p>
					...
					============================================= -->
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
										<a href="#"><i class="icon-product-hunt i-alt"></i></a>
								</div>
								<div class="fbox-content">
									
									
									<h4 class="font-weight-medium text-dark"><b>Product Promotions</b></h4>
									<p class=" text-dark">New product promotions become very easy by sending notifications with product images, details to existing customers and too your leads too. </p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h4 class="font-weight-medium text-dark"><b>Seasonal Offers / Discounts</b></h4>
									<p class=" text-dark">A special Offer / Discount is a marketing term that refers to a unique opportunity for customers to save money on certain festive seasons.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h4 class="font-weight-medium text-dark"><b>Time is Money</b></h4>
									<p class=" text-dark">Save time with Expand ERP and communicate faster with our newest WhatsApp integrated feature. By sending time-sensitive messages to Customers, Suppliers is the fastest way to reach out.
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h4 class="font-weight-medium text-dark"><b>Simple Integration</b></h4>
									<p class=" text-dark">We use API's from the WhatsApp' approved API service provider to integrate your ERP system with WhatsApp.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h4 class="font-weight-medium text-dark"><b>Quick & Faster</b></h4>
									<p class=" text-dark">As and when you do a transaction in ERP the notification will be sent to the relevant partner by getting their contact details from Master data. For internal communication contact details will be extracted from Employee master.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								<div class="fbox-icon">
										<a href="#"><i class="icon-taxi  i-alt"></i></a>
								</div>
								<div class="fbox-content">
									
									<h4 class="font-weight-medium text-dark"> <b>Deployment</b> </h4>
									<p class="text-dark">Quickly can be deployed in 3 weeks, 
Flexible and competitive pricing, 
Easy to exentend to other process area/module, 
Can be used for internal communication as well.
</p>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-price text-center text-md-center">
									 ...
									 <h4 class="mb-0 text-center text-md-center">Monthly</h4> 
										
									
									<div class="pricing-features">
										<ul class="iconlist" >
											<li><i class="icon-check text-smaller "></i> <strong>Limited</strong> Access</li>
											<li><i class="icon-check text-smaller"></i> <strong>5,000 </strong> Push notifications</li>
									...
									<div class="pricing-action text-center text-md-center">
										...
										<a href="https://www.instamojo.com/@SAVICtech/lc0a7858b85914481bcdc3cb4b08910cf/" rel="im-checkout" data-text="Pay" data-css-style="color:#ffffff; background:#ffac08; width:300px; border-radius:4px"   data-layout="vertical"></a>
								...
								<h4 class="mb-0 text-center text-md-center">Monthly</h4> 
									...
									<div class="pricing-features" >
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i> <strong>12,000 </strong> Push notifications</li>
									...
									<div class="pricing-action text-center text-md-center">
										...
										<a href="https://www.instamojo.com/@SAVICtech/l93d7b04e90224deeb3516e698192baa0/" rel="im-checkout" data-text="Pay" data-css-style="color:#ffffff; background:#ffac08; width:300px; border-radius:4px"   data-layout="vertical"></a>
<script src="https://js.instamojo.com/v1/button.js"></script>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-features" >
										<ul class="iconlist">
											<li><i class="icon-check text-smaller"></i> <strong>Premium</strong> Access</li>
											<li><i class="icon-check text-smaller"></i> <strong>15,000 </strong> Push notifications</li>
											<li><i class="icon-check text-smaller"></i> <strong>Full</strong> Access</li>
											
											<li><i class="icon-check text-smaller"></i> <strong>1 Year</strong> License</li>
											<li><i class="icon-check text-smaller"></i> <strong>24/7</strong> Support</li>
											<br>
											<li><i>Actuals if more than 15,000 messages</i></li>
										</ul>
									</div>
									<div class="pricing-action text-center text-md-center">
							...
							<div class="col-md-3">
								<div class="feature-box media-box">
									...
									<h6 class="h5 font-weight-bold mb-2">Solution Types</h6>
										<div>On SAP ECC and <br> S/4 HANA
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-terminal icon-3x"></i>
										...
										<div>Push Notification to WhatsApp</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-database icon-3x"></i>
										...
										<div>WhatsApp approved API service provider</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<i class="icon-laptop icon-3x"></i>
										...
										<div>Push notifications to Mobile App</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row col-mb-30">
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h4 class="ls0">Whatsapp for Business</h4>
								...
								<div class="col-md-6">
									<div class="feature-box p-5 media-box" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(3,27,78,.1); border: 1px solid #e5e8ed;">
										...
										<div class="fbox-content px-0">
											<h4 class="ls0">Leverage WhatsApp for Business with SAP</h4>
		...
		<div class="modal-register mfp-hide" id="modal-contact-publisher">
			<div class="card mx-auto" style="max-width: 1000px;">
				...
				<div class="card-header py-3 bg-transparent center">
					<h4 class="mb-0 font-weight-normal">Contact Publisher</h4>
	...
	<!--- to this for get it now---->
		...
		<div class="modal-register mfp-hide" id="modal-get-it-now">
			<div class="card mx-auto" style="max-width: 1000px;">
				...
				<div class="card-header py-3 bg-transparent center">
					<h4 class="mb-0 font-weight-normal"><span>Get it now<span></h4>
...
<option value="['Zimbabwe','ZW']">Zimbabwe</option>
 ...
 <br><br>
 <a href="https://www.instamojo.com/@SAVICtech/l0531bf8c074b49588f1d2c0ca205c5b6/" rel="im-checkout" data-text="Pay" data-css-style="color:#ffffff; background:#ffac08; width:300px; border-radius:4px"  data-description="" data-layout="vertical"></a>
<script src="https://js.instamojo.com/v1/button.js"></script>
				...
				<div class="heading-block center">
						...
						<div class="row no-gutters align-items-center p-4 bg-white rounded overflow-hidden flex-md-row shadow-sm position-relative mx-auto" style="max-width: 1000px">
							<div class="col p-4 d-flex flex-column center">
								<h4 class="mb-2" style="color:black;">SAVIC Technologies Private Ltd.</h4>
