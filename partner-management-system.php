...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Partner-management system</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Partner-management-system</div>
			...
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-lg clearfix">
							<div class="col-lg-6 p-0">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=wlDCbjJfX1I?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
								
									<img src="demos/business/images/sections/partner-management.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
									<i class="icon-play" style="position: absolute; top: 40%; left: 50%; font-size: 60px; color: #ccf; margin-top: -45px; margin-left: -23px"></i>
								</a>
							</div>
							<!-- Video Texts
							============================================= -->
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Partner Management App</h3>
								</div>
								<p class="font-weight-normal">FMCG companies today are staring at a major disruption in their distribution model. Other than some basic technology interventions to track primary (sales from the FMCG company to their Distributors), and in some cases, secondary sales (sales from the Distributor to the Retailers), very little changed over the decades.</p>
								<p class="font-weight-normal">This App will help Manufacturers can interact with their Suppliers or clients. There is no need anymore to rely on billboards or printed materials.</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Register yourself</b></h3>
									<p class=" text-dark">For a new user to Login, he needs to first register himself in the application by clicking register button on login page.
Few basic details like name, address, mobile No. and postal code are to be filled. User has to mention weather he/she is Seller, Buyer(customer),Agent or other in category tab </p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>Act as Supplier</b> </h3>
									<p class="text-dark">If company has a need to purchase products/services then as a Supplier specify the product, how much quantity can be delivered with timeframe, what is the price and additional charges if any (Ex: Freight, Packing, Transport, GST or other) and create Quotation. Also, you can view all your quotations created previously.
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Act as Customer</b></h3>
									<p class=" text-dark">In case you have a need to purchase products/services then as a Customer specify the product, how much quantity you want to purchase, look at the price, any seasonal discounts and additional charges if any (Ex: Freight, Packing, Transport, GST or other). Also, you can view all your sales iquiries created previously.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">Combo Deals' are another attractive feature of the sale. Customers can get an extra percentage off on buying three products together.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<p class=" text-dark">Better user experience and easy navigation
Admin can View and Approve/Reject Quotations/Inquiries,
Improved analytics with the specific timeframe,
Realtime tracking of a transaction,
Products with images can be viewed when creating Quotation/Inquiry.</p>
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>749
									</div>
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i><strong>1 GB</strong> space allocated</li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<h3>Professional</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>599
									</div>
								<h3 class="mb-0">Per User/Month</h3> 
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i><strong>25</strong> Users</li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go</li>
											<li><i class="icon-check text-smaller"></i><strong>3 GB</strong> space allocated</li>
											<li><i class="icon-check text-smaller"></i><strong>6</strong> Months Contract </li>
											<li><i class="icon-check text-smaller" style="margin-bottom:135px;"></i><strong>24/7</strong> Support</li>
										</ul>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>449 
									</div>
									<h3 class="mb-0">Per User/Month</h3> 
									...
									<div class="pricing-features">
										<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller"></i><strong>25+</strong> Users</li>
											<li><i class="icon-check text-smaller"></i>Pay-as-you-go</li>
											<li><i class="icon-check text-smaller"></i><strong>4 GB</strong> space allocated</li>
