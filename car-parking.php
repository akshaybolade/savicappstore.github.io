...
<!-- Start Favicon -->
	...
	<!-- Document Title
	============================================= -->
	<title>Car Parking Billing System</title>
<style>
			...
			<div id="page-menu-wrap">
				<div class="container">
					<div class="page-menu-row">
						...
						<div class="page-menu-title">Car Parking Billing System</div>
		...
		<section id="content">
			<div class="content-wrap p-0">
				...
				<div class="row topmargin-md clearfix" >
							<div class="col-lg-6 p-0 topmargin-sm">
								<!-- Youtube Video Link
								============================================= -->
								<a href="https://www.youtube.com/watch?v=gZGROPXeX6E?rel=0&showinfo=0" class="hero-action-link" data-lightbox="iframe">
									<img src="demos/business/images/sections/car-parking.png" alt="Youtube Video"  style="box-shadow: 0px 0px 25px 0px rgba(0,0,0,0.15); border-radius: 6px;">
							...
							<div class="col-lg-6" style="padding-left: 60px;">
								<div class="heading-block topmargin-sm bottommargin-sm border-0">
									<h3 class="nott" style="font-size: 46px; font-weight: 700; letter-spacing: -2px; line-height: 50px">Car Parking Billing System </h3>
								</div>
								<p class="font-weight-normal">Parking management system helps people find parking spots quickly and provide necessary guidelines to make the whole process smooth, reducing frustration and enhancing the visitor experience. Parking management system comprises of traveler information systems, real-time vehicle counting, real-time parking guidance display, video surveillance, and easy payment options.
</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Parking Guidance System</b></h3>
									<p class=" text-dark">Parking guidance systems, keep updating drivers with dynamic information on Parking availability within controlled areas.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"> <b>Pricing Schemes</b> </h3>
									<p class="text-dark">Variable pricing schemes (flat fares, check‑in/check‑out, long-term tickets).
</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark text-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>SaaS Model</b></h3>
									<p class=" text-dark">Flexibility with Software as a Service (SaaS) business model.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<h3 class="font-weight-medium text-dark"><b>Custom Reports	</b></h3>
									<p class=" text-dark">Enables you to manage various items in your billing application. Daily Sales Report and MIS Reports..</p>
						...
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>Automatic Boom Barriers</b></h3>
									<p class=" text-dark">Automatic boom barriers are used to control vehicular movement on places where access control is required to ensure that only authorized personnel can access the premises.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="feature-box not-dark">
								...
								<div class="fbox-content">
									...
									<h3 class="font-weight-medium text-dark"><b>UHF Reader - RFID Long Range</b></h3>
									<p class=" text-dark">UHF readers and tags offer long range vehicle identification using the latest UHF RFID technology.</p>
								</div>
							</div>
						</div>
						...
						<div class="row pricing col-mb-30 mb-4">
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4  text-center text-md-center " style="border:1px solid #ffac08;" >
									...
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>1,999
									</div>
									 <h3 class="mb-0">(Min 10 Users)/Monthly</h3> 
										
									
									<div class="pricing-features">
										<ul class="iconlist">
											<li><i class="icon-check text-smaller "></i> <strong>Masters</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>POS Billing & Offers</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Parking Guidance System</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Seasonal Passses.</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Boombarrier Integration</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Standard Reports</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>UHF & RFID Cashless transaction</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Parking Guidance System (Interface)</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>6 Months Contract </strong></li>
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center " style="border:1px solid #ffac08;">
									...
									<h3>Gold</h3>
										...
										<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit">&#x20B9;</span>1,599
									</div>
								<h3 class="mb-0">(Min 20 Users)/Monthly</h3> 
							...
							<div class="col-md-6 col-lg-4">
								...
								<div class="pricing-box pricing-simple px-4 py-4 bg-light text-center text-md-center "style="border:1px solid #ffac08;">
									...
									<div style="border-bottom:1px solid #ffac08;"></div>
									<div class="pricing-price">
										<span class="price-unit mb-0">&#x20B9;</span>1299 
									</div>
									<h3 class="mb-0">(Min 30 Users)/Monthly</h3> 
									...
									<ul class="iconlist">
											...
											<li><i class="icon-check text-smaller "></i> <strong>UHF & RFID Cashless transaction</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>Parking Guidance System (Interface)</strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>12 Months Contract </strong></li>
											<li><i class="icon-check text-smaller "></i> <strong>24/7 Support</strong></li>
						...
						<div class="row justify-content-around">
							<div class="col-md-3 bottommargin-lg">
								<div class="feature-box media-box">
									...
									<h6 class="h5 font-weight-bold mb-2">Application Types</h6>
